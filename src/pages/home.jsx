          ...
          <div className="d-flex flex-column justify-content-center ">
            <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                  ...
                  <p className='mb-3'>Save more today with Romonio</p>
    ...
    <div className="container-xxl">
      <div className="row ">
        <div className="repair-details text-center align-items-center">
          ...
          <h2 className='mb-3 text-white'>More than 40% Off on All Products And Accessories</h2>
    ...
    <div className="row">
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">I'm in love with the outfits I ordered from this store! The quality of the clothing is exceptional, and the designs are so trendy. Every time I wear something from here, I get compliments. Shopping here is a delight</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">Finding comfortable yet stylish clothes for everyday wear used to be a challenge until I discovered this store. Their collection of men's casual wear is just what I needed. The fit, fabric, and overall feel are perfect. I'm a loyal customer now!</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">As a mom, I'm always looking for durable and cute clothing options for my kids. This store has exceeded my expectations. The clothes are adorable, well-made, and have held up even after countless washes. Shopping for my little ones has never been this satisfying</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
      ...
      <div className="col-md-3 col-sm-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p className="card-text">Indulging in high-end fashion has never been more enjoyable. This boutique offers a curated selection of luxury pieces that are truly one-of-a-kind. The attention to detail and the exclusivity of the items make every purchase feel special</p>
            <Link to='about'>
            <button className="mt-4">Learn more</button>
            </Link>
          </div>
