    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b> Khilgaon,Dhaka</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at +8801875525591</a></p> </div>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Hrithik Rudra</p>
        </div>
        <div className="col-12 col-md-6">
